package com.naruto.auth.database.properties;
...
import static com.naruto.auth.database.properties.DatabaseProperties.PREFIX;
/**
 * 客户端认证配置
 */
...
public class DatabaseProperties {
     ...
     * 事务扫描基础包
     */
    private String transactionScanPackage = "com.naruto.pinda";
}
