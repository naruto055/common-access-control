package com.naruto.auth.user.resolver;

import com.naruto.auth.base.R;
import com.naruto.auth.context.BaseContextHandler;
import com.naruto.auth.user.annotation.LoginUser;
import com.naruto.auth.user.feign.UserQuery;
import com.naruto.auth.user.feign.UserResolveApi;
import com.naruto.auth.user.model.SysUser;
import com.naruto.auth.utils.NumberHelper;
