package com.naruto.auth.user.config;

import java.util.List;
import com.naruto.auth.user.feign.UserResolveApi;
import com.naruto.auth.user.interceptor.ContextHandlerInterceptor;
import com.naruto.auth.user.resolver.ContextArgumentResolver;
