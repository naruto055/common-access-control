package com.naruto.auth.log.aspect;
...
import com.naruto.auth.log.event.SysLogEvent;
import com.naruto.auth.log.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(com.naruto.auth.log.annotation.SysLog)")
